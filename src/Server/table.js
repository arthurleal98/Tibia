...
const Table = (props)=>{
                        ...
                        label.forEach((element2,index2)=>{
                            if(index2===0){
                                arr.push(<td key={`${element['name']}_${index}_${element2}`} style={styleTd}><Link to ={location=>`Player?value=${element[element2]}`} style={styleLink}>{element[element2]} </Link></td>)
                                 ...
                                 arr.push(<td key={`${element['name']}_${index}_${element2}`} style={styleTd}>{element[element2]}</td>)

                            }
                        })
                        let chave = `${element['name']}_${index}`;
    ...
    const buttons = [<div style={stylePag} key='div-buttons' >
